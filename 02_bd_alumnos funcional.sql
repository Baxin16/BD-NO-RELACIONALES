...
CREATE TABLE IF NOT EXISTS `t_alumnos` (
  ...
  `especialidad` int NOT NULL COMMENT 'especilaidad del alumno',
  `semestre` int NOT NULL COMMENT 'semestre que cursa',
  PRIMARY KEY (`id_alumno`),
  KEY `FK_t_alumnos_t_semestre` (`semestre`),
  KEY `FK_t_alumnos_t_especialidad` (`especialidad`),
  CONSTRAINT `FK_t_alumnos_t_especialidad` FOREIGN KEY (`especialidad`) REFERENCES `t_especialidad` (`id_especialidad`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_t_alumnos_t_semestre` FOREIGN KEY (`semestre`) REFERENCES `t_semestre` (`id_semestre`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla 02_bd_alumnos.t_alumnos: ~1 rows (aproximadamente)
INSERT INTO `t_alumnos` (`id_alumno`, `apellido_pat`, `apellido_mat`, `nombre`, `edad`, `correo`, `especialidad`, `semestre`) VALUES
	(1, 'Baxin ', 'Cagal', 'Kevin', 16, '2430806060604@cetis61.edu.mx', 3, 4);
...
CREATE TABLE IF NOT EXISTS `t_especialidad` (
  `id_especialidad` int NOT NULL AUTO_INCREMENT COMMENT 'id de la especilidad',
...
-- Volcando datos para la tabla 02_bd_alumnos.t_especialidad: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla 02_bd_alumnos.t_semestre
DROP TABLE IF EXISTS `t_semestre`;
CREATE TABLE IF NOT EXISTS `t_semestre` (
  `id_semestre` int NOT NULL AUTO_INCREMENT COMMENT 'id del semestre',
  `n°_semestre` char(1) NOT NULL COMMENT 'numero del semestre',
  PRIMARY KEY (`id_semestre`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla 02_bd_alumnos.t_semestre: ~6 rows (aproximadamente)
INSERT INTO `t_semestre` (`id_semestre`, `n°_semestre`) VALUES
	(1, '1'),
	(2, '2'),
	(3, '3'),
	(4, '4'),
